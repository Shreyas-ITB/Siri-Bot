...
//module.exports.run = async (client, message, args, color) => {
    ...
    //if (amount < 100) return message.channel.send("Minimum exchangeable amount is 100 bot coins (1 Siri)");

    //const siriUsername = args[2];
   // if (!siriUsername) return message.channel.send("Please specify your Duino-Coin username");
    //if (siriUsername.includes(",")) return message.channel.send("Please send a valid SiriCoin Address");
